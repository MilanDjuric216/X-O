	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 9; i++) {
			...
			do {
				...
				System.out.println("Unesite x kordinatu");
				x = scanner.nextInt();
				System.out.println("Unesite y kordinate");
				y = scanner.nextInt();
			if(array[x][y] == 0) {
				badInput = false;
				array[x][y] = player;
		...
		System.out.println("Ako zelite da odigrate ponovo unesite 1. Ako zelite da prekinete unesite bilo koji drugi broj.");
		...
		public static boolean isGameOver(byte[][] array) {
			...
			boolean b16 = array[0][2] == 2 && array[1][1] == 2 && array[2][0] == 2;
